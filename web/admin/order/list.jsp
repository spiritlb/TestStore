	...
	<HEAD>
		...
		<script type="text/javascript">
			function showDetail(oid){
				//alert(oid);
				//发送ajax
				$.post("${pageContext.request.contextPath}/AdminOrderServlet",{"method":"showDetail","oid":oid},function(d){
					//alert(d);
									...
									<c:forEach items="${list }" var="o" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state == 1 }">
													<a href="${pageContext.request.contextPath }/AdminOrderServlet?method=updateState&oid=${o.oid}">去发货</a>
												</c:if>
